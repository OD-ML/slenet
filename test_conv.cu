...
float forward_pass(double data[INSIZE][INSIZE]) {
	...
	// Convolution
	kernel_conv_filter2_1<<<cf_numBlocks2_1, cf_threadPerBlock2_1>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter2_2<<<cf_numBlocks2_2, cf_threadPerBlock2_2>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter2_3<<<cf_numBlocks2_3, cf_threadPerBlock2_3>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter2_6<<<cf_numBlocks2_6, cf_threadPerBlock2_6>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter4_1<<<cf_numBlocks4_1, cf_threadPerBlock4_1>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter4_2<<<cf_numBlocks4_2, cf_threadPerBlock4_2>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter4_3<<<cf_numBlocks4_3, cf_threadPerBlock4_3>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter4_6<<<cf_numBlocks4_6, cf_threadPerBlock4_6>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter6_1<<<cf_numBlocks6_1, cf_threadPerBlock6_1>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter6_2<<<cf_numBlocks6_2, cf_threadPerBlock6_2>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter6_3<<<cf_numBlocks6_3, cf_threadPerBlock6_3>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter6_6<<<cf_numBlocks6_6, cf_threadPerBlock6_6>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter8_1<<<cf_numBlocks8_1, cf_threadPerBlock8_1>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter8_2<<<cf_numBlocks8_2, cf_threadPerBlock8_2>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter8_3<<<cf_numBlocks8_3, cf_threadPerBlock8_3>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
	kernel_conv_filter8_6<<<cf_numBlocks8_6, cf_threadPerBlock8_6>>>(
      (float(*)[INSIZE])gInput, 
      (float(*)[CONV_OUTSIZE][CONV_OUTSIZE])convNet->pre_output, 
      (float(*)[CONV_WSIZE][CONV_WSIZE])convNet->weight);
